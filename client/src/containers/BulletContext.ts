...
import { globalActorRefs } from '../bullets/RefSync';
...
const prepareBulletInstruction = (instruction: DeepPartial<PreBulletInstruction>) => {
    const newInstruction: DeepPartial<UnevalBulletInstruction> = instruction;
...
interface IBulletContext {
    ...
    dispose: (ids: string[]) => void | undefined;
    isDead: boolean;
}
...
export const useBulletContext = (
    ...
    const addBulletGroup = useMemo(() => {
        ...
        return (
            ...
            const sounds =
                ...
                makeBulletSound(preparedInstruction.soundOptions, timings, assets);
    ...
    return { addBulletGroup, dispose, isDead };
};
